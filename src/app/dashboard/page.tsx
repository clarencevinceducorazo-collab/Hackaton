...
import { BountyDetailModal, WorkSubmission } from '../../components/dashboard/BountyDetailModal';
  ...
  return (
    <div className="min-h-screen bg-[#050810] text-[#eef2ff] font-['DM_Sans'] selection:bg-[#00d4ff]/30">
                ...
                {address ? (
                  <PayoutButton
                    ...
                    onPayoutComplete={(hash) =>
                      handlePayoutComplete(hash, bounties.find(b => b.id === submittingBountyId))
                    }
                  />
                ) : (
      ...
      <BountyDetailModal
        ...
        isOpen={isDetailOpen}
        onClose={() => { setIsDetailOpen(false); setSelectedBounty(null); }}
