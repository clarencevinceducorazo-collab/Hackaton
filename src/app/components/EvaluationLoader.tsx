...
/**
 * @fileOverview High-fidelity loading state for AI Judge evaluation.
 */
  ...
  return (
    <div className="w-full bg-[#0d1424] border border-[#00d4ff]/30 rounded-2xl p-10 relative overflow-hidden">
      ...
      <div className="flex flex-col items-center text-center relative z-10">
        ...
        <h3 className="text-2xl font-black text-[#00d4ff] mb-2 tracking-tight">
          AI Judge Evaluating...
        </h3>
        <p className="text-[#6b7a99] text-sm mb-10 max-w-[300px]">
          Reading requirements and analyzing your submission content...
        </p>

        <div className="w-full max-w-[400px] flex items-center justify-between px-4">
          <div className="flex flex-col items-center gap-2">
            <div className="w-8 h-8 rounded-full bg-[#10b981] flex items-center justify-center text-xs font-black text-[#050810]">✓</div>
            <span className="text-[10px] font-bold text-[#10b981] uppercase tracking-widest">Parsing</span>
          </div>
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <span className="text-[10px] font-bold text-[#00d4ff] uppercase tracking-widest animate-pulse">Checking</span>
          </div>
          <div className="flex-1 h-px bg-white/10 mx-2" />
          <div className="flex flex-col items-center gap-2 opacity-30">
            ...
            <span className="text-[10px] font-bold text-[#6b7a99] uppercase tracking-widest">Verdict</span>
          </div>
        </div>

        <p className="mt-12 text-[10px] text-[#6b7a99] font-mono tracking-widest uppercase">
          Gemini 1.5 Flash — avg. 2-3 seconds
        </p>
      </div>
    </div>
  );
