...
export function BountyCard({ bounty, onSubmit }: BountyCardProps) {
  ...
  return (
    <div className="bg-[#0d1424] border border-[rgba(59,130,246,0.15)] rounded-xl p-6 transition-all duration-300 hover:border-[rgba(0,212,255,0.35)] hover:-translate-y-1 group">
      ...
      <div className="flex items-center justify-between mt-auto">
        ...
        {bounty.status === 'OPEN' && (
          <button
            ...
            className="bg-[#3b82f6] hover:bg-[#00d4ff] text-white font-bold text-xs py-2 px-4 rounded-lg transition-all active:scale-95"
          >
            Submit Work
          </button>
        )}
