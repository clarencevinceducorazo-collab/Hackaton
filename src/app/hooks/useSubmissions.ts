...
const INITIAL_SUBMISSIONS: Submission[] = [
  {
    ...
    description: 'Built a fully responsive hero section with animated gradient background, CTA button with hover effects, and a background grid pattern using CSS variables.',
  ...
  },
  {
    ...
    description: 'Created a dark-themed hero component with a glassmorphism card, moving particle background, and fully responsive layout with Tailwind CSS.',
  ...
  },
  {
    ...
    description: 'Minimal hero section with spotlight effect behind the h1, animated CTA button, and a 12-column grid background. Passes Lighthouse a11y checks.',
